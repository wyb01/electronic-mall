...
<nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="<c:url value="/article/getAll"/>">电商系统,卖家系统-商品管理</a>
        </div>
        
         <div id="navbar" class="collapse navbar-collapse">
        	<ul class="nav navbar-nav">
        	   <li><a href="<c:url value="/article/getAll"/>">商品管理</a></li>
	           <li><a href="<c:url value="/articleType/getAll"/>">商品类型管理</a></li>
	           <li><a href="<c:url value="/order/getAll"/>">订单管理</a></li>
          	</ul>
        ...
        <div class="form-group">
            <div class="col-sm-4 col-sm-push-4">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    ...
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-danger" onclick="window.location='<c:url value="/user/register"/>'"><span class="glyphicon glyphicon-edit"></span>注册</button>
                    </div>
                </div>
            </div>
        </div>
