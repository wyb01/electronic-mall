...
insert into `ec_ARTICLE` (`ID`, `TITLE`, `supplier`, `PRICE`, `locality`, `putaway_date`, `storage`, `IMAGE`, `DESCRIPTION`, `TYPE_CODE`, `CREATE_DATE`) values('4','万物生光辉 ——邂逅最可爱的动物，感受最纯真的幽默。畅销全球30年自然写作经典，万物有灵且美系列自然小说之五',NULL,'23.6',NULL,NULL,'100','22639083-1_a.jpg','00020001','2012-06-11');
insert into `ec_ARTICLE` (`ID`, `TITLE`, `supplier`, `PRICE`, `locality`, `putaway_date`, `storage`, `IMAGE`, `DESCRIPTION`, `TYPE_CODE`, `CREATE_DATE`) values('5','爱你是最好的时光Ⅱ（终极大结局完结篇，当当网全国独家赠送匪我思存民国虐恋故事《兰烬》漫画版）',NULL,'17.6',NULL,NULL,'100','22630101-1_a.jpg','00020001','2012-06-11');
