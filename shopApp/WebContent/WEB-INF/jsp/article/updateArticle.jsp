...
<nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="<c:url value="/article/getAll.action"/>">电商系统,卖家系统-商品管理</a>
        </div>
...
<div class="container">
    ...
    <div class="row row-offcanvas row-offcanvas-right">
        <fieldset style="width:700px;"><legend>修改物品</legend>
            ...
            <form name="articleform" class="form-horizontal" action="${pageContext.request.contextPath}/article/updateArticle.action"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="number" class="form-control"  name="discount" value="${article.discount}" size="50" />
                    </div>
                ...
                <table align="center">
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;<input type="button" onclick="window.location = '<c:url value="/article/getAll.action"/>' ; " class="btn btn-danger btn-sm" data-dismiss="modal" value="返回" /></td>
                    </tr>
                </table>
            </form>
        </fieldset>
