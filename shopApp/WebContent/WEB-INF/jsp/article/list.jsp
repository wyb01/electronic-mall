             ...
             <ul class="nav navbar-nav navbar-right">
					<c:choose>
						<c:when test="${not empty user_session}">
							...
							<li><a href="${pageContext.request.contextPath}/user/showRegisterPage">免费注册</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="#"> <span style='color: red;'></span>
							</a></li>
							<li><a href="${pageContext.request.contextPath}/user/showLoginPage">登录</a></li>
							<li><a href="${pageContext.request.contextPath}/user/showRegisterPage">免费注册</a></li>
						</c:otherwise>
					</c:choose>
			</ul>
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="row">
            	...
            	<span class="thumbnail">
                    <a class="label label-danger" href="<c:url value="/article/removeArticle.action?id=${a.id}"/>">下架</a>
                    <a class="label label-success" href="<c:url value="/article/showUpdate.action?id=${a.id }"/>">修改</a>
